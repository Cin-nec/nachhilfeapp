...
<header>
    <nav class="nav" style="background-color: #ffffff">
        ...
        <div class="nav--explore">Entdecken... <i style="margin-left: 0.75rem" class="fa-solid fa-caret-left"></i></div>
        <div class="icon--button" style="position: absolute; right: 15rem"><i class="fa-regular fa-bell"></i></div>
        <div class="icon--button" style="position: absolute; right: 12rem"><i class="fa-regular fa-user"></i></div>
        <p class="nav--username" style="position: absolute; right: 5rem">Maurice Rösler</p>
    </nav>
    <div class="nav--sub">
        <div class="nav--sub-action"><i style="margin-right: 0.2em" class="fa-solid fa-filter"></i> Filtern</div>
        <div onclick="openPopupErstellen()" style="margin-left: 1rem" class="nav--sub-action"><i style="margin-right: 0.2em" class="fa-solid fa-plus"></i> Neues Angebot erstellen</div>
    </div>
</header>
<main class="offers--container">
    ...
    <?php foreach ($lehrerAngebote as $item): ?>
        <div class="angebote--item">
            ...
            <div class="angebote--item-content">
                ...
                <p class="angebote--item-requests">Anfragen:</p>
                <div class="angebote--item-request">
                    <div class="angebote--item-request-image"></div>
                    <p class="angebote--item-request-name">Max Mustermann</p>
                    <button class="angebote--item-request-add">ADD</button>
                </div>
                <div class="angebote--item-request">
                    <div class="angebote--item-request-image"></div>
                    <p class="angebote--item-request-name">Lisa Meier</p>
                    <button class="angebote--item-request-add">ADD</button>
                </div>
                <div class="angebote--item-request">
                    <div class="angebote--item-request-image"></div>
                    <p class="angebote--item-request-name">Tobias Neuhauer</p>
                    <button class="angebote--item-request-add">ADD</button>
                </div>
    ...
    <div class="angebote--grid" style="display: flex; align-items: center; justify-content: center; grid-column: 1 / 4">
        <h2 class="header--content-heading">Noch keine Angebote erstellt</h2>
    </div>
    <?php } ?>
</main>
