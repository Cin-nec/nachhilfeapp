...
<header>
    ...
    <div class="nav--sub">
        ...
        <div onclick="openPopupBearbeiten()" style="margin-left: 1rem" class="nav--sub-action nav--sub-hide"><i style="margin-right: 0.2em" class="fa-solid fa-pencil"></i> Angebot Bearbeiten</div>
        <div onclick="openPopupLoeschen()" style="margin-left: 1rem" class="nav--sub-action nav--sub-hide"><i style="margin-right: 0.2em" class="fa-solid fa-trash"></i> Angebot Löschen</div>
    </div>
</header>
<main class="angebot--main" style="<?php if($permission == "teacher"){ ?> background-color: #374151; <?php } else { ?>background-color: #F3F4F6<?php } ?>">
...
<section class="angebot--teilnehmer">
    ...
    <form method="post" class="angebot--eventContainer angebot--teilnehmer-container angebot--hide-first" >
        ...
        <div class="angebot--teilnehmer-wrapper">
            ...
            <button type="submit" name="teilnehmerEntfernen" value="<?php echo $gebuchteUser[$i]->userid ?>" class="angebot--teilnehmer-delete">Teilnehmer entfernen</button>
            <button type="submit" name="teilnehmerEntfernen" value="<?php echo $gebuchteUser[$i]->userid ?>" class="angebot--teilnehmer-delete angebot--teilnehmer-delete-small">Entfernen</button>
            <button type="submit" name="teilnehmerEntfernen" value="<?php echo $gebuchteUser[$i]->userid ?>" class="angebot--teilnehmer-delete angebot--teilnehmer-delete-tiny"><i class="fa-solid fa-x"></i></button>
        </div>
        <?php } ?>
        <?php } ?>
    </form>
    <form method="post" class="angebot--eventContainer angebot--teilnehmer-container angebot--hide angebot--hide-second" >
        <?php if($userAnfragen[0] == false){ echo '<p class="angebot--empty" style="margin-top: 3rem">Du hast noch keine Anfragen</p>';} else { ?>
            <?php foreach ($userAnfragen as $item) : ?>
                <div class="angebot--teilnehmer-wrapper angebot--teilnehmer-wrapper-second">
                    <div class="angebot--teilnehmer-image angebot--teilnehmer-image-second">
                    ...
                    <h2 class="angebot--teilnehmer-name angebot--teilnehmer-name-second"><?php echo ucfirst($item->username) ?></h2>
                    ...
                    <button type="submit" name="teilnehmerAnnehmen" value="<?php echo $item->userid ?>" class="angebot--anfragen-annehmen angebot--anfragen-annehmen-second">Annehmen</button>
                    <button type="submit" name="teilnehmerAblehnen" value="<?php echo $item->userid ?>" class="angebot--anfragen-ablehnen angebot--anfragen-ablehnen-second">Ablehnen</button>
                </div>
            <?php endforeach; ?>
        <?php } ?>
    </form>
    <div class="angebot--eventContainer angebot--contact-container angebot--hide angebot--hide-third ">
        ...
        <div class="angebot--contact-wrapper"><?php if(!empty($email)){ echo $email;} else { echo '<p class="angebot--contact-email">Du hast noch keine Email-Adresse angegeben</p>';} ?></div>
        <h2 class="angebot--contact-heading">Kurze Beschreibung</h2>
        <div class="angebot--contact-wrapper-big"><?php if(!empty($beschreibung)){ echo $beschreibung;} else { echo "Du hast noch keine Beschreibung angegeben";} ?></div>
        <div class="angebot--width">
...
<section id="angebotBearbeitenPopup" class="popup--hide popup--container-medium">
    <div onclick="closePopupBearbeiten()" class="popup--container-icon"><i class="fa-solid fa-x"></i></div>
    <div class="popup--container-header">
        <h2 class="popup--container-heading">Angebot bearbeiten</h2>
    </div>
...
<section id="angebotLoeschenPopup" class="popup--hide popup--container-small popup--container-medium">
    <div onclick="closePopupLoeschen()" class="popup--container-icon"><i class="fa-solid fa-x"></i></div>
    <div class="popup--container-header">
        <h2 class="popup--container-heading">Angebot löschen</h2>
    </div>
    <form method="post">
        <div class="popup--form-container">
            <p class="popup--form-label">Möchtest du dieses Angebot wirklich unwiderruflich löschen? Personen die aktuell bei der Nachhilfe angemeldet sind werden entfernt.</p>
            <div class="profil--card-form-group" style="display: flex; flex-direction: row; margin-top: 2rem">
                <button type="submit" class="button--submit" name="deleteBefehl" value="delete">
                    <i class="btn-submit-icon fa-regular fa-paper-plane"></i><p class="btn-submit-text">Löschen</p>
                </button>
...
<section id="kontaktBearbeitenPopup" class="popup--hide popup--container-medium">
    <div onclick="closePopupKontakt()" class="popup--container-icon"><i class="fa-solid fa-x"></i></div>
    <div class="popup--container-header">
        <h2 class="popup--container-heading popup--container-heading-hide">Kontakt Formular bearbeiten</h2>
        <h2 class="popup--container-heading popup--container-heading-fivehundred">Kontakt Formular </h2>
    </div>
    <form method="post">
        <div class="popup--form-container">
            <p class="popup--form-label">Gebe hier bspw. deine Email-Addresse an, unter der dich dein Schüler kontaktieren soll.</p>
            <input style="margin-top: 1rem" class="form--input-text" name="email" type="email" maxlength="64" placeholder="<?php if(!empty($email)){ echo $email;} else { echo "Email-Adresse";} ?>">
            <p style="margin-top: 1rem" class="popup--form-label">Gebe hier noch eine kurze sinnvolle Beschreibung an:</p>
            <textarea name="beschreibung" class="form--input-textarea" style="margin-top: 1rem" maxlength="300"><?php if(!empty($beschreibung)){ echo $beschreibung;} else { echo "Du hast noch keine Beschreibung angegeben";} ?></textarea>
            <div class="profil--card-form-group" style="display: flex; flex-direction: row; margin-top: 2rem">
...
<section id="toggleSubNavView" class="popup--hide popup--container-medium popup--container-small popup--container-right">
    ...
    <div class="nav--sub-list">
        ...
        <div onclick="openPopupBearbeiten()" style="margin-left: 1rem" class="nav--sub-action nav--sub-action-dark"><i style="margin-right: 0.2em" class="fa-solid fa-pencil"></i> Angebot Bearbeiten</div>
        <div onclick="openPopupLoeschen()" style="margin-left: 1rem" class="nav--sub-action nav--sub-action-dark"><i style="margin-right: 0.2em" class="fa-solid fa-trash"></i> Angebot Löschen</div>
    </div>
</section>
