...
<header>
    ...
    <div class="nav__sub">
        ...
        <a style="text-decoration: none" href="/angeboteAngefragt" class="nav__sub-action nav__sub--hide"><i style="margin-right: 0.2em;" class="fa-solid fa-arrow-rotate-left"></i> Zurück zur Übersicht</a>
        <div onclick="openPopupAbbrechen()" style="margin-left: 1rem" class="nav__sub-action nav__sub--hide"><i style="margin-right: 0.2em" class="fa-regular fa-circle-xmark"></i> Anfrage abbrechen</div>
    </div>
</header>
<main class="angebot__main" style="background-color: #F3F4F6">
    <div class="angebot__wrapper">
        ...
        <div class="angebot__content">
            ...
            <div onclick="openPopupAbbrechen()" class="angebot__link">Anfrage abbrechen</a>
            </div>
        </div>
</main>
<section class="angebot__teilnehmer">
    ...
    <ul class="angebot__teilnehmer-subnav">
        <li class="angebot__teilnehmer-list--active angebot__teilnehmer-list">Aktionen</li>
    </ul>
    <div class="angebot__contact-container" style="height: 15rem">
        <p class="angebot__contact-explanation">
            Du hast eine Anfrage an dieses Angebot gesendet. Warte auf eine Antwort oder breche die Anfrage ab.
        </p>
        <div class="angebot__teilnehmer-container">
            <button onclick="openPopupAbbrechen()" class="angebot__contact-edit">Anfrage abbrechen</button>
        </div>
    </div>
    <ul class="angebot__teilnehmer-subnav">
...
<section id="angebotAbbrechenPopup" class="popup--hide popup__container--small popup__ontainer--medium">
    <div onclick="closePopupAbbrechen()" class="popup__container-icon"><i class="fa-solid fa-x"></i></div>
    <div class="popup__container-header">
        <h2 class="popup__container-heading">Anfrage abbrechen</h2>
    </div>
    <form method="post">
        <div class="popup__form-container">
            <p class="popup__form-label">Möchtest du die Anfrage an dieses Angebot wirklich beenden?</p>
            <div class="profil__card-form-group" style="display: flex; flex-direction: row; margin-top: 2rem">
                <button type="submit" class="button--submit" name="anfrageAbbrechen" value="abbrechen">
                    <i class="button--submit-icon fa-regular fa-paper-plane"></i><p class="btn-submit-text">Bestätigen</p>
                </button>
...
<section id="toggleSubNavView" class="popup--hide popup__ontainer--medium popup__container--small popup--container-right">
    ...
    <div class="nav__sub-list">
        <a style="text-decoration: none" href="/angeboteAngefragt" class="nav__sub-action nav__sub-action--dark"><i style="margin-right: 0.2em;" class="fa-solid fa-arrow-rotate-left"></i> Zurück zur Übersicht</a>
        <div onclick="openPopupAbbrechen()" style="margin-left: 1rem" class="nav__sub-action nav__sub-action--dark"><i style="margin-right: 0.2em" class="fa-regular fa-circle-xmark"></i> Anfrage abbrechen</div>
    </div>
</section>
