...
<header>
    ...
    <div class="nav__sub">
        ...
        <div onclick="openPopupBeenden()" style="margin-left: 1rem" class="nav__sub-action nav__sub--hide"><i style="margin-right: 0.2em" class="fa-solid fa-trash"></i> Nachhilfe beenden</div>
    </div>
</header>
<main class="angebot__main" style="background-color: #F3F4F6">
    <div class="angebot__wrapper">
        ...
        <div class="angebot__content">
            ...
            <div onclick="openPopupBeenden()" class="angebot__link">Nachhilfe beenden</a>
        </div>
    </div>
</main>
<section class="angebot__teilnehmer">
    ...
    <ul class="angebot__teilnehmer-subnav">
        <li class="angebot__teilnehmer-list--active angebot__teilnehmer-list">Kontaktdaten</li>
    </ul>
    <div class="angebot__contact-container angebot__contact-container--small">
    ...
    <div class="angebot__contact-container angebot__contact-container--small">
        ...
        <div class="angebot__teilnehmer-container">
            <button onclick="openPopupBeenden()" class="angebot__contact-edit">Nachhilfe beenden</button>
        </div>
    </div>
    <ul class="angebot__teilnehmer-subnav">
...
<section id="angebotBeendenPopup" class="popup--hide popup__container--small popup__ontainer--medium">
    <div onclick="closePopupBeenden()" class="popup__container-icon"><i class="fa-solid fa-x"></i></div>
    <div class="popup__container-header">
        <h2 class="popup__container-heading">Nachhilfe beenden</h2>
    </div>
    <form method="post">
        <div class="popup__form-container">
            <p class="popup__form-label">Möchtest du die Nachhilfe bei diesem Angebot wirklich beenden?</p>
            <div class="profil__card-form-group" style="display: flex; flex-direction: row; margin-top: 2rem">
                <button type="submit" class="button--submit" name="nachhilfeBeenden" value="beenden">
                    <i class="button--submit-icon fa-regular fa-paper-plane"></i><p class="btn-submit-text">Beenden</p>
                </button>
...
<section id="toggleSubNavView" class="popup--hide popup__ontainer--medium popup__container--small popup--container-right">
    ...
    <div class="nav__sub-list">
        ...
        <div onclick="closePopupSubNavToggle(); openPopupBeenden()" style="margin-left: 1rem" class="nav__sub-action nav__sub-action--dark"><i style="margin-right: 0.2em" class="fa-solid fa-trash"></i> Nachhilfe beenden</div>
    </div>
</section>
